  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="可选值列表" width="120" align="center">
...
export default {
  ...
  methods: {
    ...
    handleUpdate(index, row) {
      this.$router.push({ path: '/pms/updateProductAttr', query: { id: row.id, cid: row.productAttributeCategoryId, cname: this.$route.query.cname } })
    },
